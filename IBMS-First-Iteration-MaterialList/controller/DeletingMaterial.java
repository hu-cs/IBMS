...
public class DeletingMaterial implements ActionListener {
	...
	int deletingMaterial() {
		...
		if (selctedRow != -1) {
			...
			JOptionPane.showMessageDialog(null,"جهت پاک نمودن نام محصول لطفـــــــــآ یک ردیف را انتخاب نمایید ! ",  " هشدار  ", JOptionPane.OK_OPTION);
//			new JOptionPane().showMessageDialog(null, "Please select a row!");
			return -1;
		}
		return 0;
	}
