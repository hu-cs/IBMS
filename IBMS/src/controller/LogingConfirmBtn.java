...
public class LogingConfirmBtn implements ActionListener {
	...
	private int isTrue() {
		...
		if (((userName.getText().equalsIgnoreCase(Login.userAccountList.get(0)
				...
				.equalsIgnoreCase(Login.userAccountList.get(0).getPassWord())))
				|| ((userName.getText().equalsIgnoreCase(Login.userAccountList
						.get(1).getUserName())) && (password.getText()
						.equalsIgnoreCase(Login.userAccountList.get(1)
								.getPassWord())))) {
