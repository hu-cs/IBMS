...
public class mainUi extends JFrame {
	...
	public mainUi() {
		...
		JMenuItem menuItem_6 = new JMenuItem("حسابات سال 2013 (پیش �?رض)");
		...
		JMenuItem menuItem_8 = new JMenuItem("�?اکتور �?روش");
		...
		JMenuItem menuItem_4 = new JMenuItem("اضا�?ه نمودن جنس جدید");
		...
		JMenu compantExpenditureMenu = new JMenu("حساب مصار�?");
		...
		JMenu corruprionExpenditureMenu = new JMenu("مصار�? استهلاک");
		...
		JMenuItem variuosMenuItem = new JMenuItem("مت�?رقه");
		variuosMenuItem
				.setComponentOrientation(ComponentOrientation.RIGHT_TO_LEFT);
		...
		JMenuItem addedMaterialMenuItem = new JMenuItem("موارد اضا�?ه شده");
		...
		JButton button = new JButton("اضا�?ه نمودن جنس جدید");
		panel.add(button);
