...
public class EditConsumptionItem extends JDialog {
	...
	public EditConsumptionItem(JTable maintable, String title,
			String invoiceLastNumber) {
		...
		button.addActionListener(new EditExpence(table, title,
				invoiceLastNumber, this, dbTable, CompanyConsumption.table,
				CompanyConsumption.selectTypeCombo));
