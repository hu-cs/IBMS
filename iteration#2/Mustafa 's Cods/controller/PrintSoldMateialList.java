...
public class PrintSoldMateialList implements ActionListener {
	JTable table;

	public PrintSoldMateialList(JTable table) {
		this.table = table;
	}
	...
	private void print() {
		...
		String head = " لیست فروش محصولات  " + name + "  در سال  " + dateYearId;
