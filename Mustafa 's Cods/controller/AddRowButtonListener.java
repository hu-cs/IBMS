	...
	private void addRowToTable() {
		...
		if (table.getRowCount() <= 13) {
			if (table.getValueAt(table.getRowCount() - 1, 0) != null) {
				...
				table.setValueAt(table.getRowCount(), table.getRowCount() - 1,
						5);
			...
			new JOptionPane()
					.showMessageDialog(
							null,
							"شما نمیتوانید بیشتر از 14 ردیف در داخل یک فاکتور وارد کنید! لطفا اطلاعات را در صورت لزوم در فاکتور بعدی قرار داهید!",
